    ...
    jQuery(window).on("elementor/frontend/init", function() {
        var s, i, l, n, e = elementorModules.frontend.handlers.Base.extend({
            ...
            getFloatingTarget: function() {
                ...
                return elementorFrontendConfig.experimentalFeatures.hasOwnProperty("e_optimized_markup") && 1 == elementorFrontendConfig.experimentalFeatures.e_optimized_markup && !t ? this.$element : this.findElement(".elementor-widget-container")
            },
            ...
            run: function() {
                ...
                this.getFxVal("translate_toggle") && ((this.getFxVal("translate_x.size") || this.getFxVal("translate_x.sizes.to")) && (t.translateX = {
                    ...
                    duration: this.getFxVal("scale_duration.size"),
                    delay: this.getFxVal("scale_delay.size") || 0
                }), (this.getFxVal("translate_toggle") || this.getFxVal("rotate_toggle") || this.getFxVal("scale_toggle")) && (this.getFloatingTarget().css("will-change", "transform"), this.anime = window.anime && window.anime(t))
            }
        });
